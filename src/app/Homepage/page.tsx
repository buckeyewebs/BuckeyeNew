    ...
    return (
        <div className="overflow-x-hidden">
          ...
          <div className="w-[1280px] h-auto">
            <div className="w-[1280px] h-auto pt-[50px] pr-[108px] pl-[81px] pb-[20px] sm:pb-[130px] md:pb-[140px] lg:pb-[152px] flex flex-col">
              <div className="mt-[20px] mb-[37px] w-[549px] h-auto flex items-center">
