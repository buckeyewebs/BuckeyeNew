      ...
      <div className="w-[1280px] h-auto">
        <div className="w-[1280px] h-auto pt-[50px] pr-[108px] pl-[81px] pb-[20px] sm:pb-[130px] md:pb-[140px] lg:pb-[152px] flex flex-col md:flex-row">
          <div className="mt-[20px] mb-[37px] w-[549px] h-auto">
            <p className="font-lancelot text-center  lg:text-[68px] tracking-tight leading-[1.3] text-[40px] sm:text-[46px] md:text-[58px]  ">
              Building Websites <br />
              that grow your <br />
              business
            </p>
            <div className="w-[275px] h-[60px] mt-[20px] rounded-[43px] border border-black pt-[17px] pl-[53px] 
sm:w-[300px] sm:h-[70px] sm:pl-[60px] 
md:w-[350px] md:h-[80px] md:pl-[70px] 
lg:w-[400px] lg:h-[90px] lg:pl-[80px] 
transition duration-300 ease-in-out hover:bg-black hover:text-white">                <Link href="/QuoteRequestForm">
